...
public class RefCompteRepositoryTests extends EntityTest {
    ...
    public void test_B_findAllItemByVcKey() {
        ...
        List<BankAccountDTO> refCompteList = refCompteRepository.findAllItemByVcKey(lawfirmEntity.getVckey(), EnumLanguage.FR.getShortCode());
    ...
    public void test_C_findDTOById() {
        ...
        BankAccountDTO bankAccountDTO = refCompteRepository.findDTOById(lawfirmEntity.getVckey(), refCompte.getIdCompte(), EnumLanguage.FR.getShortCode());
