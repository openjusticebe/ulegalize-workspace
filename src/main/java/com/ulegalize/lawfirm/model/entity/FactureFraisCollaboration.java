...
@Entity
@Table(name = "t_facture_frais_collaboration")
public class FactureFraisCollaboration implements Serializable {
    ...
    @Column(columnDefinition = "BIGINT", name = "FRAIS_ID", nullable = false)
    @Getter
    @Setter
    ...
    public boolean equals(Object o) {
        ...
        FactureFraisCollaboration that = (FactureFraisCollaboration) o;
