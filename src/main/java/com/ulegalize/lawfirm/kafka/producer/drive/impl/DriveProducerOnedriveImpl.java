...
@Component(value = "driveProducerOnedrive")
@SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
@Slf4j
public class DriveProducerOnedriveImpl implements IDriveProducer {
    ...
    public DriveProducerOnedriveImpl(RestTemplate restTemplate) {
...
//            jsonObject.put("paths", paths);
            ...
            ResponseEntity<String> result = restTemplate.exchange(DRIVE_DROPBOX_URL + "v2/onedrive/folders", HttpMethod.POST, request, String.class);
        }
    ...
    public void createContainer(UlegalizeToken ulegalizeToken, String containerName, List<String> paths) throws LawfirmBusinessException {
        log.error("Don't create a container {} for onedrive", containerName);
        throw new LawfirmBusinessException("Don't create a container " + containerName + " for onedrive");
