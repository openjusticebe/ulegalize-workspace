...
public interface TSecurityGroupUsersRepository extends JpaRepository<TSecurityGroupUsers, Long>, JpaSpecificationExecutor<TSecurityGroupUsers> {
    @Query("select tSecurityGroupRightsList.idRight" +
            " from TSecurityGroupUsers tsgu " +
            " join tsgu.tSecurityGroups securityGroup " +
            " join securityGroup.tSecurityGroupRightsList tSecurityGroupRightsList " +
            " where tsgu.user.id = :idUser " +
            " and securityGroup.vcKey = :vcKey" +
            " and securityGroup.tSecAppGroupId in :enumSecurityAppGroups ")
    List<EnumRights> findByIdUserAndVckey(Long idUser, String vcKey, List<EnumSecurityAppGroups> enumSecurityAppGroups);
    ...
    List<TSecurityGroupRights> findByIdUserAndVckeyAndEqual(Long idUser, String vcKey, EnumSecurityAppGroups enumSecurityAppGroups);
    ...
    List<TSecurityGroupUsers> findByVckeyAndRight(String vcKey, EnumSecurityAppGroups enumSecurityAppGroup);
    ...
    @Query("select tsgu" +
            ...
            " and securityGroup.vcKey = :vcKey" +
            " and securityGroup.tSecAppGroupId = :enumSecurityAppGroup ")
    List<TSecurityGroupUsers> findBySecGroupUserIdAndVckey(Long secGroupId, String vcKey, EnumSecurityAppGroups enumSecurityAppGroup);
    ...
    @Query("select tsgu " +
            ...
            " and sg.vcKey = :vcKey ")
    List<TSecurityGroupUsers> findByTSecurityGroupsIdAndVckey(Long securityGroupId, String vcKey);
    ...
    List<TSecurityGroupUsers> findByIdAndVckey(Long id, String vcKey);
